	...
	<header class="navbar pcoded-header navbar-expand-lg navbar-light header-blue">
				...
				<div class="m-header">
					...
					<a href="#!" class="b-brand">
						...
						<img src="{$template.assetsDir}images/logo.png" alt="" class="logo">
						<img src="{$template.assetsDir}images/logo-icon.png" alt="" class="logo-thumb">
					</a>
								...
								<div class="dropdown-menu dropdown-menu-right notification">
									...
									<ul class="noti-body">
										...
										<li class="notification">
											<div class="media">
												<img class="img-radius" src="{$template.assetsDir}images/user/avatar-1.jpg" alt="Generic placeholder image">
										...
										<li class="notification">
											<div class="media">
												<img class="img-radius" src="{$template.assetsDir}images/user/avatar-2.jpg" alt="Generic placeholder image">
												<div class="media-body">
						...
						<li>
							<div class="dropdown drp-user">
								...
								<div class="dropdown-menu dropdown-menu-right profile-notification">
									<div class="pro-head">
										<img src="{$template.assetsDir}images/user/avatar-1.jpg" class="img-radius" alt="User-Profile-Image">
										<span>John Doe</span>
										<a href="{$template.baseUrl}login/logout" class="dud-logout" title="Logout">
                ...
                <ul class="iew-download">
                    <li>
                        <a href="http://www.google.com/chrome/">
                            <img src="{$template.assetsDir}images/browser/chrome.png" alt="Chrome">
                            <div>Chrome</div>
                        </a>
                    </li>
                    <li>
                        <a href="https://www.mozilla.org/en-US/firefox/new/">
                            <img src="{$template.assetsDir}images/browser/firefox.png" alt="Firefox">
                            <div>Firefox</div>
                        </a>
                    </li>
                    <li>
                        <a href="http://www.opera.com">
                            <img src="{$template.assetsDir}images/browser/opera.png" alt="Opera">
                            <div>Opera</div>
                        </a>
                    </li>
                    <li>
                        <a href="https://www.apple.com/safari/">
                            <img src="{$template.assetsDir}images/browser/safari.png" alt="Safari">
                            <div>Safari</div>
                        </a>
                    </li>
                    <li>
                        <a href="http://windows.microsoft.com/en-us/internet-explorer/download-ie">
                            <img src="{$template.assetsDir}images/browser/ie.png" alt="">
                            <div>IE (11 & above)</div>
                        </a>
                    </li>
                </ul>
